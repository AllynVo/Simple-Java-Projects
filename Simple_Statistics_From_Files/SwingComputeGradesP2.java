//Allyn Vo
//Project 2, part 2, Swing window based prompts off of part 1
//2-21-2017
//CS 111
...
public class SwingComputeGradesP2 extends GradedActivity implements Display{

   //implements DisplayInterface
   public void inputDisplay()
   {
   } // prompts for input files (graphically)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////   
   public static void main(String[] args) throws IOException, WrongFormatException{
      Display obj = new SwingComputeGradesP2();
      obj.inputDisplay();
      obj.finalDisplay();
      
      Scanner keyboard = new Scanner(System.in);
      try{ //Try 1
         String fileName =   // The variable 
         JOptionPane.showInputDialog ( "What is the name of the file with students and their scores? ex. \"projA.txt\"" );
...
///////////////////////////////////////////////////////////////////////////////////////////////////// 
         String fileName2 =   // The variable 
         JOptionPane.showInputDialog ( "What is the name of the rubric file? ex. \"projA-rub.txt\"" );
         ...
         for(int j=0; j<stuArr.length; j++){
            for(int i=0; i<2; i++){
               try{
                  ...
                  String nameError = "Non letter character in students name in students file, at line: " + (j+1);
                  JOptionPane.showMessageDialog ( 
                  null, nameError, "ERROR", 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////         
         ...
         for(int j=0; j<rubArr.length; j++){
               try{
                  ...
                  //custom title, error icon
                  String rubNameError = "Non letter character in rubric name in students file, at line: " + (j+1);
                  JOptionPane.showMessageDialog ( 
                  null, rubNameError, "ERROR", 
                  JOptionPane.ERROR_MESSAGE);
                  System.exit(0);
               }
         }
         ...
         for (int i=0; i<stuArr.length; i++){
             for(int j=2; j<stuArr[i].length; j++){
                 try{ //Try 2
                    ...
                    System.out.println("Error: Non number found in rubric at line: " + (j-1));
                    //custom title, error icon
                    String scoreError = "Non number found in rubric at line: " + (j-1);
                    JOptionPane.showMessageDialog ( 
                    null, scoreError, "ERROR", 
                    JOptionPane.ERROR_MESSAGE);
                    System.exit(0);
                 }           
             }
         ...
         for (int i=0; i<stuArr.length; i++){
             for (int j=2; j<stuArr[i].length; j++){
                 try{ //Try 3
                    ...
                    System.out.println("Error: Non number found in file containing students and their scores at line: " + (i+1));
                    //custom title, error icon
                    String stuScoreError = "Non number found in file containing students and their scores at line: " + (i+1);
                    JOptionPane.showMessageDialog ( 
                    null, stuScoreError, "ERROR", 
                    JOptionPane.ERROR_MESSAGE);
                    System.exit(0);
                 }           
             }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         try{
            ...
            //custom title, error icon
            String weightError = "The weights of the rubrics do not add up to 100, instead, it adds up to: " + rubTotal;
            JOptionPane.showMessageDialog ( 
            null, weightError, "ERROR", 
            JOptionPane.ERROR_MESSAGE);
            System.exit(0);
         }    
/////////////////////////////////////////////////////////////////////////////////////////////////////             
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         writer.flush();
         writer.close();
//Extra parts for part two of project 2//////////////////////////////////////////////////////////////
         //number of students   
         System.out.println("Number of students is: " + stuArr.length);
         //highest score
         double highestScore=0;
         for(int i=0; i<avg.length; i++){
            if(avg[i]>highestScore)
               highestScore = avg[i];
         }
         ...
         avgScore = avgScore / avg.length;
         System.out.println("Average student scores is: " + avgScore);
         //Standard Deviation
         double variance=0;
         double track = 0;
         for(int i=0; i<avg.length; i++){
            track += (avg[i]-avgScore)*(avg[i]-avgScore);
         }
         variance = track/(avg.length-1);
         System.out.println("The standard deviation is: " + Math.sqrt(variance));
         
         output.append("\nNumber of students is: " + stuArr.length +
                        "\nHighest score is: " + highestScore +
                        "\nLowest score is: " + lowestScore +
                        "\nAverage student scores is: " + avgScore +
                        "\nThe standard deviation is: " + Math.sqrt(variance));
/////////////////////////////////////////////////////////////////////////////////////////////////////      
String tokenError = output.toString();
            JOptionPane.showMessageDialog ( 
            null, output, "Statistics", 
            JOptionPane.INFORMATION_MESSAGE);
/////////////////////////////////////////////////////////////////////////////////////////////////////      
      }//end of try 1
      catch (FileNotFoundException e){
         System.out.println("Error: An expected file not found.");
         //custom title, error icon
            String fileError = "An expected file not found.";
            JOptionPane.showMessageDialog ( 
            null, fileError, "ERROR", 
            JOptionPane.ERROR_MESSAGE);
            System.exit(0);
         ...
         //custom title, error icon
            String tokenError = "Error: There is an extra token in the input.";
            JOptionPane.showMessageDialog ( 
            null, tokenError, "ERROR", 
            JOptionPane.ERROR_MESSAGE);
            System.exit(0);
      }
