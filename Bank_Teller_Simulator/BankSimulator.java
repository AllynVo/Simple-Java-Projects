...
class BankSimulator
{
    ...
    private void setupParameters()
    {
        ...
        do {
            System.out.print("Enter simulation time (max is 100): ");
            simulationTime = input.nextInt();
        } while (simulationTime > 100 || simulationTime < 0);
        /*
        do {
            System.out.print("Enter maximum transaction time of customers (max is 500): ");
            maxTransactionTime = input.nextInt();
        } while (maxTransactionTime > 20 || maxTransactionTime < 0);
        */
        /*
        do {
    ...
    private void getCustomerData()
    {
        ...
        */    
        //} else {
            ...
            transactionTime = dataRandom.nextInt(20 - 5 + 1) + 5;
        //}
    }
    ...
    private void doSimulation() throws InterruptedException
    {
        ...
        //(int numTellers, int customerQlimit, int startTellerID)
        servicearea = new ServiceArea(numTellers, 10, 1);
        ...
        for (int currentTime = 0; currentTime < simulationTime; currentTime++) {
            ...
            if (anyNewArrival) {
                ...
                // Step 1A: setup customer data
                customerIDCounter++;
                System.out.println("\tCustomer #" + customerIDCounter
                        + " arrives with transaction time " + transactionTime + " unit(s).");
                System.out.println("\t\tExisting customer priorities increased.");
                
                // Step 1B: check customer waiting queue too long?
            ...
            while (servicearea.numBusyTellers() > 0 && servicearea.getFrontBusyTellerQ().getEndBusyIntervalTime() == currentTime) {
                ...
                System.out.println("\tCustomer #" + teller.getCustomer().getCustomerID() + " is done. Leaves.");
                double averageCWaitingTime = ( servicearea.emptyCustomerQ() )
